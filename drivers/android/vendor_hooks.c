...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_blk_execute_rq);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_blk_mq_get_tag);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_customize_force_ra);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_el0_impdef_exception);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_f2fs_buffer_write);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_f2fs_down_read);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_f2fs_move_data_block_bypass);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_f2fs_ra_data_block_bypass);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_f2fs_write_cache_pages);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_fiq_dump);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_folio_prepare_wb_folio_wait);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_freq_qos_update_request_v2);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_gh_vcpu_run_return);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_kmalloc_large_fallback_cma);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_mm_customize_alloc_anon_thp);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_mm_folio_split_bypass);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_rq_qos_wait);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_sme_smstart);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_adjust_iocb_flags);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_binder_before_restore_priority);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_binder_skip_set_priority);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_check_swap_entries_free);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_cpu_domain_power_down_ok);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_customize_ractl);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_customize_swapin_gfp_mask);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_f2fs_customized_ioctl);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_f2fs_dnode_set_blkaddr);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_f2fs_file_open);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_f2fs_improve_priority);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_f2fs_inode_may_compress);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_filemap_alloc_folio);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_filemap_end_dropbehind_bypass);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_folio_alloc_swap_finish);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_free_large_kmalloc_bypass);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_mem_cgroup_over_high_penalty);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_mem_cgroup_over_high_reclaim);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_mm_folio_split_supported);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_mm_truncate_try_split_folio);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_page_pool_validate_mp_ops);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_pci_pwrctrl_should_skip);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_preempt_lazy_mode);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_rtmutex_lock_released);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_rwsem_lock_acquired);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_set_ioprio);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_shrink_folio_lock_owner_clear);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_shrink_folio_lock_owner_set);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_shrink_try_release_folio);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_swap_alloc_fast_bypass);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufs_mcq_cleanup);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufs_use_threaded_intr);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_update_percpu_swap_cluster_bypass);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_wbt_track);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_wbt_wait);
