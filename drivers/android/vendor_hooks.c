...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_printk_console_emit_next_record);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_psci_system_reset2);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_folios_put_refs_direct_free);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_adjust_timer_slack);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_readahead_bypass);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_filemap_read_folio_bypass);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_xhci_handle_offload);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_folio_expected_ref_count);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_smaps_rollup_contended);
